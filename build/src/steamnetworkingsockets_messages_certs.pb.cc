...
void InitDefaultsCMsgSteamNetworkingIdentity() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsCMsgSteamNetworkingIdentityImpl);
}
...
CMsgSteamNetworkingIdentity* CMsgSteamNetworkingIdentity::New(::google::protobuf::Arena* arena) const {
  CMsgSteamNetworkingIdentity* n = new CMsgSteamNetworkingIdentity;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
  ...
  if (cached_has_bits & 0x00000002u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        11, *this->identity_, deterministic, target);
  }
